        ...
        <List sx={{ ml: '8px', mt: '7.6px' }}>
          <ListItem sx={{ mb: '4px', pl: { xs: '0px', lg: '16px' } }}>
            <ListItemButton>
              ...
              <ListItemText sx={{ my: '0px' }} primaryTypographyProps={{ color: '#FE645E', fontSize: '16px', lineHeight: '18.77px', fontWeight: 500 }} primary='My products'/>
            </ListItemButton>
          </ListItem>
          ...
          <ListItem sx={{ mb: '4px', pl: { xs: '0px', lg: '16px' } }}>
            <ListItemButton>
              ...
              <ListItemText sx={{ my: '0px' }} primaryTypographyProps={{ fontSize: '16px', lineHeight: '18.77px', fontWeight: 500 }} primary='Settings'/>
            </ListItemButton>
          </ListItem>
